    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='profile_pictures/default.jpg',
                ...
                ('date_of_birth', models.DateField(blank=True,
                                                   null=True, verbose_name='Date of birth(mm/dd/yyyy) ')),
                ('marital_status', models.CharField(choices=[('single', 'Single'), (
                    'married', 'Married'), ('widowed', 'Widowed'), ('divorced', 'Divorced')], max_length=20)),
                ...
                ('roles', models.CharField(choices=[('staff', 'STAFF'), ('business_unit', 'BUSINESS UNIT'), (
                    'student', 'STUDENT'), ('visitor', 'VISITOR')], default='visitor', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='admin_portal.lifechoicesmember')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True,
                                        primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Annual Leave', 'Annual Leave'), ('Sick Leave', 'Sick Leave'), ('Family Leave', 'Family Leave'), (
                    'Unpaid Leave', 'Unpaid Leave'), ('Study Leave', 'Study Leave'), ('Compensation Leave', 'Compensation Leave'), ('Other Leave', 'Other Leave')], max_length=45)),
                ('pre_authorisation', models.BooleanField(default=False)),
                ('personal_message', models.CharField(
                    blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            == == == =
            >>>>>> > Pillz_user-registration-groups
            name='BankingDetail',
            fields=[
                ('id', models.AutoField(auto_created=True,
                                        primary_key=True, serialize=False, verbose_name='ID')),
