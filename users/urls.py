...
from .views import Register, PendingAccounts, ActivatePendingAccount, activate_account, ViewProfile, AdminPageView, \
...
urlpatterns = [
    ...
    path('update-banking-details/', update_bankingdetails, name='update-banking-details'),
