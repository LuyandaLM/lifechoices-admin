...
from .views import Register, RegisterParttwo, PendingAccounts, ActivatePendingAccount, activate_account, ViewProfile, \
    AdminPageView, RegistrationConfirmation, update_profile, update_bankingdetails, update_kin_details, \
...
urlpatterns = [
    ...
    path('register/step-2/', RegisterParttwo.as_view(), name='register2'),
